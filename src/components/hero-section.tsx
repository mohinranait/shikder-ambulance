...
export function HeroSection() {
  return (
    <section className="relative bg-premium-light-gradient py-20 lg:py-32">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl">
                Professional medical emergency response with trained paramedics, advanced life support equipment, and
                GPS-enabled rapid dispatch.
              </p>
            </div>
