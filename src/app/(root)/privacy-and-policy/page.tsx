...
export const metadata: Metadata = {
  title: "Privacy Policy | Shikder Ambulance Service",
  description:
    "Privacy Policy: Shikder Ambulance Service is the largest and trusted company in Bangladesh. We provide emergency ambulance service from Dhaka to all districts. If you need any types of Ambulance, Call Us. ",
  keywords:
    "Freezing Ambulance Services. Coffin Transport Freezing Ambulance Dhaka, Dhaka Mortuary Ambulance Service.",
  authors: [{ name: "Shikder Ambulance" }],
  alternates: {
    canonical: "https://shikderambulance.com/privacy-and-policy",
  },
  openGraph: {
    title: "Privacy Policy - Shikder Ambulance Service",
    description:
      "Privacy Policy: Shikder Ambulance Service is the largest and trusted company in Bangladesh. We provide emergency ambulance service from Dhaka to all districts.",
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 mb-5">Last Updated: 01-01-2026 </p>
