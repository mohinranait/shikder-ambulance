...
export const metadata: Metadata = {
  title: "About Us - Shikder Ambulance Service",
  description:
    "About Us - Shikder Ambulance company is ther largest and trusted company. Shikder Ambulance offers 24/7 emergency ambulance service in Dhaka and nearby areas with AC, Non-AC, ICU, and freezing ambulance support. If you need the best ambulance service then contact us.",
  keywords:
    "About Us, About Shikder Ambulance, Ambulance Services. freezing ambulance, dead body carrier, ambulance service Dhaka, freezer ambulance Bangladesh, mortuary ambulance, body transportation service, dead body carrier frozen ambulance, Dhaka Airport freezing Ambulance, frozen ambulance, Shikder Freezing Ambulance, Dhaka Burial Transport Ambulance, Coffin Transport Freezing Ambulance Dhaka, Dhaka Mortuary Ambulance Service.",
  authors: [{ name: "Shikder Ambulance" }],
  alternates: {
    canonical: "https://shikderambulance.com/about-us",
  },
  openGraph: {
    title: "About Us - Shikder Ambulance Service",
    description:
